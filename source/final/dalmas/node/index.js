var app = require('express')(); // Implement express
var http = require('http').Server(app); // necessary for Node.js server
var io = require('socket.io')(http); // Implement socket.io
var port = 3000;
