...
create your own filter just like the directive app.filter('newFilter', function()
filer examples
* currency
* data
* filter
...
letter 'b' it would return everything with the letter 'b'.
...
URLs allowing the website transition from one view to another seamlessly.
...
directly and the new data and update it with the view.
...
should the same just camel case.
...
of the behaviors. [w3schools]_ [Lau]_ [Ray]_
